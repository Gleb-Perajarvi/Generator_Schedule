        ...
        public int CreateRaspF(int WorkWeeks, int RabDays, string key) // добавим потом в передачу словарь
        {
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    if (count1 > 5500) // добавил проверку, если количество попыток превышает 5500, то уже пора заканчивать, скорее невозможно составить расписание по заданным параметрам.
                    {
